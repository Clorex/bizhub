              ...
              <>
                ...
                <SectionCard title="Budget & duration" subtitle="More budget = more exposure">
                  <div className="space-y-3">
                    ...
                    <div>
                      <p className="text-xs text-biz-muted mb-1">Daily budget (minimum ₦1,700)</p>
                      <Input
                        type="number"
                        min={1700}
                        step={100}
                ...
                <Card className="p-4">
                  ...
                  {!canContinue ? (
                    <p className="mt-2 text-[11px] text-red-700">
                      Select at least 1 product (max {maxProducts}), and use at least 2 days + ₦1,700/day.
                    </p>
                  ) : null}
                </Card>
              </>
              ...
              <>
                <div className="rounded-[26px] p-4 text-white shadow-float bg-gradient-to-br from-biz-accent2 to-biz-accent">
                  ...
                  <p className="text-[11px] opacity-95 mt-2">
                    Duration: <b>{safeDays} day(s)</b> • Daily budget: <b>{fmtNaira(safeDaily)}</b>
                  </p>
                  ...
                  <div className="space-y-2">
                    {selectedProducts.map((p: any) => (
                      <div key={String(p.id)} className="rounded-2xl border border-biz-line bg-white p-3">
                        ...
                        <p className="text-[11px] text-biz-muted mt-1">₦{Number(p?.price || 0).toLocaleString()}</p>
                      </div>
                    ))}
                  </div>
                </SectionCard>
